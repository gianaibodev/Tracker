-- Update break allowances to match user's requested labels
...
-- Update get_session_summary to return a more useful format if needed, 
-- but we can handle the formatting in the UI as well.
-- Let's just ensure it returns clean data.
